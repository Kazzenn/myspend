...
| **PHP** | >= 8.4.5 | - |
| **Protocol version** | 10 | - |
| **MySQL** | >= 8.4.5 | 10.6.20-MariaDB |
| **Web Server** | Apache/2 | support .htaccess |
...
1. เข้า **Databases** บน DirectAdmin (บน Account Manager) หากรับบน localhost ให้ไปที่ localhost/phpmyadmin แล้วทำตามข้อที่ 3,5
2. เลือก **Create Database**
3. ตั้งชื่อ **Database** แล้วบันทึก
4. กลับไปหน้า **DirectAdmin** เลื่อนลงไปที่หัวข้อ **Extra Features**  แล้วกด **phpMyAdmmin** 
...
ทดลองโหลดไฟล์ใหม่ [ที่นี่](https://github.com/PHPMailer/PHPMailer/archive/master.zip) แล้วนำไปวางในไฟล์เดียวกับโฟลเดอร์เดียวกับ **send_reset_email.php** (ตรวจสอบว่า redirect ถูกต้องหรือไม่)
```php
