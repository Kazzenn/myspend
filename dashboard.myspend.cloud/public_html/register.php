...
<head>
    ...
    <meta name="description" content="สมัครสมาชิก MySpend ฟรี ใช้งานระบบบันทึกรายรับรายจ่ายและดูสถิติการเงินได้ทันที">
<meta name="keywords" content="สมัครสมาชิก MySpend, register บัญชีส่วนตัว, จัดการการเงิน">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <script src="https://js.hcaptcha.com/1/api.js" async defer></script>
    <title>MySpend - สมัครสมาชิก</title>
    <style>
...
<body>
    <div class="container-box">
        <h1>MySpend Register</h1>
        <form action="reg_db.php" method="post" id="registerForm">
            ...
            <div class="input-group">
                ...
                <input type="password" name="password_1" placeholder="รหัสผ่าน (อย่างน้อย 6 ตัวอักษร)" required>
            </div>
            ...
            <div class="input-group">
                <div class="hcaptcha-container">
                    <div class="h-captcha" 
                         data-sitekey="0c2ebc06-bb48-44aa-8024-e2ece00cd31e"
            ...
            <div class="input-group">
                <button type="submit" name="reg_user" class="btn btn-success" id="registerButton" disabled>สมัครสมาชิก</button>
